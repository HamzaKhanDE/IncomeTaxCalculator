...
public class TaxCalculatorUI extends Application {
    ...
    public void start(Stage stageObj) {
        ...
        // Listener for Slider
        FilingSlider.valueProperty().addListener(new ChangeListener<Number>() {
            public void changed(ObservableValue<? extends Number> ov,
                                Number old_val, Number new_val) {
                filingStatus = (int)FilingSlider.getValue();
            }
        });
    ...
    // Calculates NYS Income Tax
    public double stateTax(double income, int filingStatus) {
        double tax = 0;

        // Consider if Single or Married Filing Separately
    ...
    public double federalTax(double income, int filingStatus) {
        ...
        // Consider if Married Filing Separately
        if (filingStatus == 2) {
            if (income <= 9526) {
                tax = income * 0.1;
                federalTaxRate = 10;
